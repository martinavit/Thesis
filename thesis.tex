...
\thesistitle{Search for heavy neutral leptons in pp collision events with three charged leptons using the CMS detector} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\cosupervisor{Prof. Dr. Dirk \textsc{Ryckbosch}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\include{Parts/quotation1}

\include{Parts/abstract}
\include{Parts/abstractD}
...
% Include the appendices of the thesis as separate files from the Appendices folderD
