...
%Eq.~\ref{eq:dirac} an RH particle disappears at a point and an LH
%particle appears. Therefore weak (chiral) charge is not conserved, but
%the lepton numbers are conserved, as we started with a
...
%weak charge is not conserved, and neither is the lepton number. We started
