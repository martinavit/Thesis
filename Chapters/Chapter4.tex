...
very well known SM processes; it results we have to consider a novel
background contribution too.\\
In Figure~\ref{fig:c4LLbgk} the phase space of long-lived HNL is
...
the decay products invariant mass and
the displacement. This strategy will be presented in
Chapter~\ref{Chapter6} where careful selected mass windows are removed
