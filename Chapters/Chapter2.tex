...
from the point where the interaction occured, particles enter in the
...
Figure~\ref{fig:pfscheme}). The indentification of leptons, the
...
In order to reduce the number of jets rising from misreconstruction or
...
\caption{On the left, ``performance of the DeepCSV and DeepFlavour b
  ...
  for jets of different flavours in \ttbar events. Jets without a
...
A brief overview of the reconstruction of PF elements" from the signals in individual sub-detectors
