...
First the CMS experiment will be introduced in Chapters~\ref{Chapter2} and~\ref{Chapter2_5}, then the heavy neutral leptons model will be explained in Chapter~\ref{Chapter3} trying to show the reason behind the huge enthusiasm about this topic. In the past $\sim10$ years a very active research community has arised, and an impressive numbers of papers and several proposal for new experiments were published. Considering that, finally the two searches for heavy neutral leptonss at CMS are presented in Chapters~\ref{Chapter5} and~\ref{Chapter6} at which the author has firsthand participated during her PhD.
