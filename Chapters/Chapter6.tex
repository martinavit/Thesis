...
\begin{figure}[h]
\noindent
\makebox[\textwidth]{  \subfloat[]{\includegraphics[width=.275\textwidth]{Figures/c6/object/tracking_M-4_V-0p00290516780927_rho.png}
  \includegraphics[clip,trim=2cm 0 0 0,width=0.25\textwidth]{Figures/c6/object/tracking_M-8_V-0p000547722557505_rho.png}}
  \subfloat[]{\includegraphics[clip,trim=2cm 0 0 0,width=0.25\textwidth]{Figures/c6/object/loose_validFraction_M-4_V-0p00290516780927_rho.png}
  \includegraphics[clip,trim=2cm 0 0 0,width=0.25\textwidth]{Figures/c6/object/loose_validFraction_M-8_V-0p000547722557505_rho.png}}}\\
 \makebox[\textwidth]{ \subfloat[]{\includegraphics[width=.275\textwidth]{Figures/c6/object/goodTrack_goodGlobal_M-4_V-0p00290516780927_rho.png}
...
\subfloat[]{\includegraphics[clip,trim=2cm 0 0 0,width=0.25\textwidth]{Figures/c6/object/globalTrack_cuts_M-4_V-0p00290516780927_rho.png}
  \includegraphics[clip,trim=2cm 0 0 0,width=0.25\textwidth]{Figures/c6/object/globalTrack_cuts_M-8_V-0p000547722557505_rho.png}}}
...
\begin{figure}[h]
\noindent
\makebox[\textwidth]{  \subfloat[]{\includegraphics[width=.25\textwidth]{Figures/c6/selection/genE_vs_pt_sortby_prov_m4.png}
  \includegraphics[width=.25\textwidth]{Figures/c6/selection/genE_vs_eta_sortby_prov_m4.png}}
  \subfloat[]{\includegraphics[width=.25\textwidth]{Figures/c6/selection/l2l3_mass_gen.png}
  \includegraphics[width=.25\textwidth]{Figures/c6/selection/l2l3_mass_rec.png}}}\\
 \makebox[\textwidth]{ \subfloat[]{\includegraphics[width=.25\textwidth]{Figures/c6/selection/l2l3_dR_gen.png}
  \includegraphics[width=.25\textwidth]{Figures/c6/selection/l2l3_dR_rec.png}}
\subfloat[]{\includegraphics[width=.25\textwidth]{Figures/c6/selection/l1l3_dPhi_gen.png}
  \includegraphics[width=.25\textwidth]{Figures/c6/selection/l1l3_dPhi_rec.png}}}
...
\noindent
\makebox[\textwidth]{
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_DeltaR_l2_l3__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_minDeltaphil1_other__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_M_lll__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_numberofb_jets__0.pdf}}\\
\makebox[\textwidth]{
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_cosSVposl2_l3dir__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_vertexchi2_probabilityl2_l3__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/e_sigmaDeltaPV_SV_2D__0.pdf}
...
\noindent
\makebox[\textwidth][l]{
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_DeltaR_l2_l3__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_minDeltaphil1_other__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_M_lll__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_numberofb_jets__0.pdf}}\\
\makebox[\textwidth][l]{
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_cosSVposl2_l3dir__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_vertexchi2_probabilityl2_l3__0.pdf}
  \includegraphics[clip,trim=0.9cm 0 0.7cm 0,width=.25\textwidth]{Figures/c6/selection/18/mu_sigmaDeltaPV_SV_2D__0.pdf}
...
\begin{figure}[h]
  \noindent
  \makebox[\textwidth]{
  \includegraphics[width=.26\textwidth]{Figures/c6/selection/18/e_DeltaPV_SV_2D_zomm__final.pdf}
  \includegraphics[width=.26\textwidth]{Figures/c6/selection/18/mu_DeltaPV_SV_2D_zomm__final.pdf}
  \includegraphics[width=.26\textwidth]{Figures/c6/selection/18/e_M_ll_l2_l3_zoom__final.pdf}
  \includegraphics[width=.26\textwidth]{Figures/c6/selection/18/mu_M_ll_l2_l3_zoom__final.pdf}}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.45\textwidth]{Figures/c6/backgrounds/FR/sFR/QCD/dxy_ele_eta1_FR2.pdf}
  \includegraphics[width=.45\textwidth]{Figures/c6/backgrounds/FR/sFR/QCD/dxy_mu_eta1_FR2.pdf}\\
  \includegraphics[width=.45\textwidth]{Figures/c6/backgrounds/FR/sFR/QCD/dxy_ele_eta2_FR2.pdf}
  \includegraphics[width=.45\textwidth]{Figures/c6/backgrounds/FR/sFR/QCD/dxy_mu_eta2_FR2.pdf}\\
  \includegraphics[width=.45\textwidth]{Figures/c6/backgrounds/FR/sFR/QCD/dxy_ele_eta3_FR2.pdf}
...
\begin{figure}[h]
  \noindent
  \makebox[\textwidth]{
  \includegraphics[width=.51\textwidth]{Figures/c6/backgrounds/FR/closureTest/Data/SideBandPlusBjet/M-6_V-0p00202484567313_mu_muo_datacard_combined_SR.pdf}
  \includegraphics[width=.51\textwidth]{Figures/c6/backgrounds/FR/closureTest/Data/SideBandPlusBjet/M-6_V-0p00202484567313_e_ele_datacard_combined_SR.pdf}}\\
\noindent
  \makebox[\textwidth]{
...
\end{table}
 ...
 \begin{figure}[h]
    \noindent
\makebox[\textwidth]{\includegraphics[width=.54\textwidth]{Figures/c6/backgrounds/FR/closureTest/Data/conversion/M-6_V-0p00202484567313_e_ele_datacard_combined_SR.pdf}
  ...
  \makebox[\textwidth]{\includegraphics[width=.38\textwidth]{Figures/c6/backgrounds/FR/closureTest/Data/conversion/M-6_V-0p00202484567313_e_ele_mass_datacard_combined_massl2l3.pdf}
...
\noindent
\makebox[\textwidth]{
		\includegraphics[width=0.33\textwidth]{Figures/c6/efficiencies/1dplots/2016tot/ksnorm3small}
		\includegraphics[width=0.33\textwidth]{Figures/c6/efficiencies/1dplots/2017tot/ksnorm3small}
		\includegraphics[width=0.33\textwidth]{Figures/c6/efficiencies/1dplots/2018tot/ksnorm3small}}
...
\begin{figure}[h]
\noindent
\makebox[\textwidth]{  \includegraphics[clip,trim=0 0 2cm 0,width=.51\textwidth]{{Figures/c6/systematics/2018/e_ele/M-6_V-0.00202484567313_normalized}.pdf}
  \includegraphics[clip,trim=0 0 2cm 0,width=.51\textwidth]{{Figures/c6/systematics/2018/mu_muo/M-6_V-0.00202484567313_normalized}.pdf}}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.40\textwidth]{Figures/c6/results/_final/majorana/M-2_V-0p011225_e_ele_disp_datacard_combined_displacement.pdf}
  \includegraphics[width=.40\textwidth]{Figures/c6/results/_final/majorana/M-2_V-0p011225_mu_muo_disp_datacard_combined_displacement.pdf}\\
  \includegraphics[width=.40\textwidth]{Figures/c6/results/_final/majorana/M-2_V-0p011225_e_ele_mass_datacard_combined_massl2l3.pdf}
  \includegraphics[width=.40\textwidth]{Figures/c6/results/_final/majorana/M-2_V-0p011225_mu_muo_mass_datacard_combined_massl2l3.pdf}\\
  \includegraphics[width=.65\textwidth]{Figures/c6/results/_final/majorana/M-2_V-0p011225_e_ele_datacard_combined_SR}\\
...
\clearpage
\subsection{Dirac interpretation}\label{subsec:dirac}
\begin{figure}[h]
  \centering
   \includegraphics[width=.30\textwidth]{Figures/c6/results/_final/dirac/M-2_V-0p011225_e_Dirac_ele_disp_datacard_combined_displacement.pdf}
  \includegraphics[width=.30\textwidth]{Figures/c6/results/_final/dirac/M-2_V-0p011225_mu_Dirac_muo_disp_datacard_combined_displacement.pdf}\\
  \includegraphics[width=.30\textwidth]{Figures/c6/results/_final/dirac/M-2_V-0p011225_e_Dirac_ele_mass_datacard_combined_massl2l3.pdf}
  \includegraphics[width=.30\textwidth]{Figures/c6/results/_final/dirac/M-2_V-0p011225_mu_Dirac_muo_mass_datacard_combined_massl2l3.pdf}\\
  \includegraphics[width=.51\textwidth]{Figures/c6/results/_final/dirac/M-2_V-0p011225_e_Dirac_ele_datacard_combined_SR}\\
...
SR plots and tables with the signal yields at the exclusion curve can be found after the limits plots in Appendix.~\ref{AppendixC}.
