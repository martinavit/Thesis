...
bins for the high-mass category, we opted for a lower number of bins, as
follows:
\begin{itemize}
...
\begin{align}
\vcenter{\hbox{\includegraphics[clip,trim=0cm 0cm 0.5cm 0cm, width=.62\textwidth]{Figures/c6/efficiencies/figs_Displacement.png}}}
&\qquad
\begin{aligned}
