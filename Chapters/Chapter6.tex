...
In the following sections, they are listed and motivated only the selections circumscribed
...
(~\ref{sec:c2muondisplaced}) will be referred to as ``tight \displ
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.36\textwidth]{Figures/c6/selection/18/e_DeltaPV_SV_2D_zomm__final.pdf}
  \includegraphics[width=.36\textwidth]{Figures/c6/selection/18/mu_DeltaPV_SV_2D_zomm__final.pdf}\\
  \includegraphics[width=.36\textwidth]{Figures/c6/selection/18/e_M_ll_l2_l3_zoom__final.pdf}
  \includegraphics[width=.36\textwidth]{Figures/c6/selection/18/mu_M_ll_l2_l3_zoom__final.pdf}
