...
\begin{figure}[h!]
\centering
\includegraphics[ width=0.34\textwidth]{Figures/c5/distribution/mt_minMos_highM_3lOSSF_withSignal.pdf}
\includegraphics[ width=.34\textwidth]{Figures/c5/distribution/minMos_highM_3lOSSF_withSignal.pdf}
\includegraphics[width=.34\textwidth]{Figures/c5/distribution/minMos_highM_3lnoOSSF_withSignal.pdf}
\caption{The distributions of \mtmin and \mmin for
