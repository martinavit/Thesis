...
\emph{My contributions to the analysis presented here are the following: I designed the analysis in the
high-mass region and parts of the analysis in the low-mass region, and developed the procedure for
correcting the exclusion limits for the sterile neutrino lifetime. In addition I produced the final results
in the search regions, and control regions, made all of the published plots, wrote the bulk of the
internal CMS documentation relating to the analysis, and was the main editor of the resulting paper.
Several other people made large contributions to the analysis presented here:
Lesya Shchutska initially started the analysis effort, partially designed the low mass search regions,
and advised me throughout my work on this topic. Lesya also contributed to the design of the lifetime
correction procedure, and in the editing of the paper.
Tom Cornelis made all simulations of N production events. In particular he trailblazed the simulation
of sterile neutrinos with a significant lifetime, which was nontrivial to implement in practice.
Without these simulations, the analysis would have been impossible. Tom also helped with the estimation
of the trigger effciencies. Martina Vit performed the measurement of the lepton fake rate. This facilitates the prediction of
the most important background in the analysis. She was also involved in the design of the analysis in
the low-mass region.}