...
nonprompt leptons with a machine learning algorithm. It results in an increase in effciency
per lepton of 20\% and for the same signal
effciency a reduction of the
...
of 3\abinv. Furthemore a new analysis strategy is proposed. To extent
...
will contribuite to have better timing and spatial resolutions, and
...
enviroment will make object reconstruction and particle
...
Additional muon chambers will be set up in the endacaps. They will be included in
the muon trigger at L1. The supplementary hits in the
endcap, with improved algorithms, will allow high trigger efficciency 
on displaced muon tracks regardless of the high occupancy environment of the HL-LHC.
 

The proposed MIP timing detector (MTD) will
consist in a barrel and an endcap region formed by a single layer device between the tracker
and calorimeters, and cover $|\eta|$ up to $\sim$3.
MTD will improve reconstruction by: collecting timing information on
charged particles, combining tracking with timing, providing a timing resolution
at the start of HL-LHC $\sim$ 30--40 ps for \pt treshold of 0.7\GeV, barrel degrades to 50--60 ps
at end of HL-LHC. Mitigation of pile-up effect from HL-LHC
\begin{wrapfigure}{l}{0.5\textwidth}
\centering
    \includegraphics[clip,trim=0.5cm 1cm 0.cm 3cm, width=.48\textwidth]{Figures/c7/MDT.pdf}
\caption{Efficiency as a function of the timing
resolution of the MTD for reconstruction of a specific SyperSymmetry
