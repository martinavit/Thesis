...
\input{hnldefs.tex} % all the definitions of symbols and variables
...
\thesistitle{Search for Heavy Neutral Leptons in events with three charged leptons
 in pp collision at s $= \sqrt13$ TeV at CMS detector} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Dr. Prof Didar \textsc{Dobur}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
